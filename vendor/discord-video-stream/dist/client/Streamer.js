...
export class Streamer {
    ...
    joinVoice(guild_id, channel_id) {
        return new Promise((resolve, reject) => {
            ...
            const voiceConn = new VoiceConnection(this, guild_id, user_id, channel_id, (conn) => {
                resolve(conn);
            });
    ...
    createStream() {
        return new Promise((resolve, reject) => {
            ...
            const streamConn = new StreamConnection(this, clientGuildId, clientUserId, clientChannelId, (conn) => {
                resolve(conn);
            });
