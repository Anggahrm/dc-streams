...
export declare namespace Message {
    ...
    type DavePrepareTransition = {
        transition_id: number;
        protocol_version: number;
    };
    type DaveExecuteTransition = {
        transition_id: number;
    };
    type DaveTransitionReady = {
        transition_id: number;
    };
    type DavePrepareEpoch = {
        epoch: number;
        protocol_version: number;
    };
    type MlsInvalidCommitWelcome = {
        transition_id: number;
    };
}
...
export type GatewayRequest = GatewayRequest.Identify | GatewayRequest.Resume | GatewayRequest.Heartbeat | GatewayRequest.SelectProtocol | GatewayRequest.Video | GatewayRequest.Speaking | GatewayRequest.DaveTransitionReady | GatewayRequest.MlsInvalidCommitWelcome;
export {};
