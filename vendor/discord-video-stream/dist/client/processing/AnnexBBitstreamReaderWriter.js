    ...
    readBits(count) {
        ...
        while (count > 0) {
            ...
            if (this._bitOffset === 0 && count >= 8) {
                ...
                const newBits = (this._buffer[this._byteOffset] >>
...
export class AnnexBBitstreamWriter {
    ...
    writeSigned(num, count) {
        if (count <= 0)
            return;
        if (count > 32)
            throw new Error("writeSigned supports up to 32 bits");
...
//# sourceMappingURL=AnnexBBitstreamReaderWriter.js.map