export declare enum AVCodecID {
    ...
    AV_CODEC_ID_FIRST_AUDIO = 65536,///< A dummy id pointing at the start of audio codecs
    ...
    AV_CODEC_ID_FIRST_SUBTITLE = 94208,///< A dummy ID pointing at the start of subtitle codecs.
    ...
    AV_CODEC_ID_FIRST_UNKNOWN = 98304,///< A dummy ID pointing at the start of various fake codecs.
    ...
    AV_CODEC_ID_PROBE = 102400,///< codec_id is not known (like AV_CODEC_ID_NONE) but lavf should attempt to identify it
    AV_CODEC_ID_MPEG2TS = 131072 /**< _FAKE_ codec to indicate a raw MPEG-2 TS
     * stream (only used by libavformat) */,
    AV_CODEC_ID_MPEG4SYSTEMS = 131073 /**< _FAKE_ codec to indicate a MPEG-4 Systems
     * stream (only used by libavformat) */,
    AV_CODEC_ID_FFMETADATA = 135168,///< Dummy codec for streams containing only metadata information.
    AV_CODEC_ID_WRAPPED_AVFRAME = 135169,///< Passthrough codec, AVFrames wrapped in AVPacket
    /**
