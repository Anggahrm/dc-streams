...
function parseOpusPacketDuration(frame) {
        ...
        try {
            switch (codecId) {
                case AVCodecID.AV_CODEC_ID_H264:
                    ...
                    vbsf.push(BitStreamFilterAPI.create("h264_metadata", vStream, {
                        options: {
                            aud: "remove",
                        },
                    }));
                ...
                case AVCodecID.AV_CODEC_ID_HEVC:
                    ...
                    vbsf.push(BitStreamFilterAPI.create("hevc_metadata", vStream, {
                        options: {
                            aud: "remove",
                        },
                    }));
...
//# sourceMappingURL=LibavDemuxer.js.map